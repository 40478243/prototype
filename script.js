...
const exit_button = intro_box.querySelector(".buttons .quit");
const continue_button = intro_box.querySelector(".buttons .restart");
...
const f1 = () => {
    intro_box.classList.add("activeInfo"); //show info box
}
...
continue_button.onclick = () => {
    intro_box.classList.remove("activeInfo"); //hide info box
